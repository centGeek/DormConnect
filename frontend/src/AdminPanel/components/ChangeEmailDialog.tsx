          ...
          <div className="fixed inset-0 flex w-screen items-center justify-center p-4">
            ...
            <DialogPanel className="max-w-lg space-y-4 border bg-white p-12">
              ...
              <Description>
                ...
                <input onChange={(e) => setEmail(e.target.value)} type="email" className="block w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Wpisz nowy adres e-mail" />
